...
include "navbar.php";
   ?>
     ...
     <img src="reebokwall1.jpg"style="width:100%; height:100%;"></img>
   <!-- <img src="adidas.png"style="width:236px; height:149px;margin-left:10%;  margin-top:-30%;"></img> -->

<!-- <div class="container-fluid"> -->
<div class="row">
<?php
$adi= array('reebok1.jpg', 'reebok2.jpg', 'reebok3.jpg','reebok5.jpg');
